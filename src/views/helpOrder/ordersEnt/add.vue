        ...
        <a-row>
          <a-col :span="12">
            <a-form-item label="求助单名称">
              <a-input v-decorator="['userName', {rules: [{required: true, message: '请输入求助单名称'}]}]" placeholder="请输入名称" />
            </a-form-item>
          </a-col>
          <a-col :span="12">
            <a-form-item label="求助单状态">
              <a-tree-select
                  placeholder="请选择求助单状态" 
                  v-decorator="['industryId']"
        ...
        <a-row>
          <a-col :span="12">
            <a-form-item label="求助单提交人">
              <a-input v-decorator="['phone', {rules: [{required: true, message: '请输入求助单提交人'}]}]" placeholder="请输入求助单提交人" />
            </a-form-item>
          </a-col>
          <a-col :span="12">
        ...
        <a-row>
          <a-col :span="24">
            <a-form-item label="描述" :label-col="{ span: 4 }" :wrapper-col="{ span: 20 }">
                <a-textarea placeholder="请输入描述" :rows="4" v-decorator="['remark',  { rules: [ { max:150, message: '描述' }] }]" />
            </a-form-item>
          </a-col>
        </a-row>
...
import { addCourseManager } from '@/httpsAPI/help'
    export default {
        data(){
            return {
